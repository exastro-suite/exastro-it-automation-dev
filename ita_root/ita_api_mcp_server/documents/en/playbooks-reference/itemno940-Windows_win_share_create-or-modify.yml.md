...
## Overview
Creates or updates a Windows folder share, setting its name, description, path, listing permission, and full/change/read access lists, skipping entries with an empty share name.
## Description
