    ...
    try:
        ...
        # OASEのmongo設定（インデックスなど）
            ...
            try:
                ...
                labeled_event_collection.create_index([("exastro_duplicate_collection_settings_ids", ASCENDING), ("labels._exastro_end_time", ASCENDING), ("exastro_dup_notification_queue", ASCENDING), ("labels._exastro_fetched_time", ASCENDING)], name="consolidated_check")
