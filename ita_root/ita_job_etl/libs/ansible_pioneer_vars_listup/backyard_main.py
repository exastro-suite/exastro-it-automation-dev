...
from libs.ansible_pioneer_vars_listup.classes import *  # noqa: F403
from libs.ansible_pioneer_vars_listup.functions import util
...
def backyard_main(ws_db):
    ...
    g.LANGUAGE = 'en'
    # if 'USER_ID' not in g:
    g.USER_ID = const.ANSIBLE_PIONEER_VARS_LISTUP_USER_ID
    proc_loaded_row_id = const.PROC_LOADED_ID_ANSIBLE_PIONEER
