...
CREATE or REPLACE VIEW V_COMN_PROC_LOADED_ANSIBLE_LEGACY_VARS_LISTUP AS
...
WHERE PROC_NAME = 'ky_legacy_varsautolistup-workflow' AND LOADED_FLG = '0';

GRANT SELECT ON TABLE V_COMN_PROC_LOADED_ANSIBLE_LEGACY_VARS_LISTUP TO ITA_USER;
