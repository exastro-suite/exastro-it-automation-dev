...
class CICD_GrandChildWorkflow():
    ...
    def getTargetMatlLinkRow(self, tgtMatlLinkRow):
        ...
        sql = (
            ...
            "  T8.ANS_EXEC_OPTIONS                MV_ANS_EXEC_OPTIONS, "
            "  T8.AG_EXECUTION_ENVIRONMENT_NAME   MV_AG_EXECUTION_ENVIRONMENT_NAME, "
            "  T8.AG_BUILDER_OPTIONS              MV_AG_BUILDER_OPTIONS, "
    ...
    def executeMovement(self, row, run_mode):
        ...
        if DriverType in ansible_driver_list:
            movement_row = {
                ...
                "ANS_EXEC_OPTIONS": row['MV_ANS_EXEC_OPTIONS'],
                "AG_EXECUTION_ENVIRONMENT_NAME": row['MV_AG_EXECUTION_ENVIRONMENT_NAME'],
                "AG_BUILDER_OPTIONS": row['MV_AG_BUILDER_OPTIONS'],
